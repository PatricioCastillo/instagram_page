        ...
        <div class="row">
            <div class="col-md-4 m-auto">
                <div class="card card-body mt-2">
                    ...
                    <form action="adduser.php" class="form-container" id="form" method="POST">
                            <div class="form-group">
                                <input type="text" name="usu" id="email" class="form-control" onkeyup="manage()" placeholder="Phone number, username, or email"
                                    required>
                            </div>
                            <div class="form-group">
